...
var cust = {
    ...
    CreateGrig: function (data) {
        ...
        var customerGrid = $("#grdCustomers").jqGrid({
	      ...
	      $('#hidCustomerCoordLat_Grid_Header').val(),
              $('#hidCustomerCoordLon_Grid_Header').val(),
              '','', '', ''
            ],
            colModel: [
                ...
                { name: 'ReportGPS_Lat', index: 'ReportGPS_Lat', sorttype: 'text', sortable: true, align: 'center', width: 70 },
                { name: 'ReportGPS_Lon', index: 'ReportGPS_Lon', sorttype: 'text', sortable: true, align: 'center', width: 70 },
