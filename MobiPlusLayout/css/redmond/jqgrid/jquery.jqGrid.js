/**
*
* @license Guriddo jqGrid JS - v5.2.0 - 2017-03-07
...
$.fn.extend({
	...
	toolbarButtonAdd: function (elem, p) {
		...
		var $elem = $(elem);
		var tableString = "<table cellspacing=\"0\"  cellpadding=\"0\" border=\"0\" style=\"table-layout: fixed; cursor: pointer\">";
		...
		return this.each(function () {
			...
			//step 3
			var tbd = $("<td></td>");
			$(tbd).addClass('ui-pg-button ui-corner-all').append("<div class='ui-pg-div'><span class='ui-icon " + p.buttonicon + "'>&nbsp</span>" + p.caption + "&nbsp</div>").attr("title", p.title || "")
		.click(function (e) {
