<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportTrucksAndTrailors.aspx.cs" Inherits="Pages_Compield_ReportTrucksAndTrailors" %>
    ...
    <form id="form1" runat="server">
        <asp:ScriptManager ID="ScriptManager1" runat="server">
            <Scripts>
                ...
                <asp:ScriptReference Path="~/js/trucksAndTrailors.js" />
        ...
        <div>
            <div id="divTrucksAndTrailors" style="width: 100%; overflow: auto;">
                <table id="grdTrucksAndTrailors">
                </table>
                <div id="grdTrucksAndTrailorsPager">
                </div>
            </div>
        </div>
