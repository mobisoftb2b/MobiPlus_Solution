<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QuestionaireReport.aspx.cs" Inherits="Pages_Compield_QuestionaireReport" %>
   ...
   <form id="form1" runat="server">
        <asp:ScriptManager ID="ScriptManager1" runat="server">
            <Scripts>
                ...
                <asp:ScriptReference Path="~/js/questionaireReport.js" />
