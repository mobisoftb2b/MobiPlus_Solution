<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TrucksAndTrailorInspection.aspx.cs" Inherits="Pages_Compield_TrucksAndTrailorInspection" %>
    ...
    <form id="form1" runat="server">
        <asp:ScriptManager ID="ScriptManager1" runat="server">
            <Scripts>
                ...
                <asp:ScriptReference Path="~/js/trucksAndTrailorsInsp.js" />
        ...
        <asp:HiddenField ID="hidDistribution_Grid_Header" ClientIDMode="Static" runat="server" />
        <asp:HiddenField ID="hidCarNumber_Grid_Header" ClientIDMode="Static" runat="server" />
        ...
        <asp:HiddenField ID="hidFileName_Grid_Header" ClientIDMode="Static" runat="server" />
