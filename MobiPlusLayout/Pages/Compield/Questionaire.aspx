<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Questionaire.aspx.cs" Inherits="Pages_Compield_Questionaire" %>
    ...
    <form id="form1" runat="server">
        <asp:ScriptManager ID="ScriptManager1" runat="server">
            <Scripts>
                ...
                <asp:ScriptReference Path="~/js/questionaire.js" />
        ...
        <div>
            <div id="divQuestionaire" style="width: 100%; overflow: auto;">
                <table id="grdQuestionaire">
                </table>
                <div id="grdQuestionairePager">
                </div>
            </div>
        </div>
