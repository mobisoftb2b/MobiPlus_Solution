...
<body id="dBodyr" >
    ...
    <div>
        <div class="dProfileAll">
            <div class="txtPartsGridContainer" style="width: 655px; height: 600px">
                ...
                <div class="PartsEdit MessageBox" >
    ...
    <div id="dEditWinMSGItemBox" class="EditWinMSGItemBox">
        <div class="JumpWiX">
            <img alt="<%=StrSrc("Close")%>" src="../../img/X.png" class="imngX" onclick="CloseEditWinMSGItemBox();" />
        </div>
                ...
                <td class="EditForm val Pop">
                    <%--<span id="aPop" href="#" onclick="ShowCtlPopulations();" style="color: Blue;text-decoration:underline;cursor:pointer">אוכלוסיות</span>--%>
                     <table cellpadding="0" cellspacing="0">
                        <tr>
                            <td>
                                <span id="aPop" href="#" onclick="ShowCtlPopulations();" style="color: Blue;text-decoration:underline;cursor:pointer"><div style="color:Black;text-decoration:'none' !important;"> <%=StrSrc("Loading")%>...<img alt=" <%=StrSrc("Loading")%>..." src="../../img/loading1.gif" width="16px"/></div></span>
                            </td>
                        </tr>
                    </table>
                </td>
    ...
    function SetGrid() {
            ...
            $("#jQGrid").jqGrid({
                ...
                colNames: ['#',' <%=StrSrc("FromDate")%>', '<%=StrSrc("ToDate")%>', '<%=StrSrc("Message")%>',' <%=StrSrc("Populations")%>','AgentsPopulation','CustomersPopulation','ItemsPopulation'],
