<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DayEndPopup.aspx.cs" Inherits="Pages_Compield_DayEndPopup" %>
...
<body>
    <form id="form1" runat="server">
		...
		<asp:ScriptReference Path="~/js/jszip.min.js" />
                ...
                <asp:ScriptReference Path="~/js/endDayPopup.js" />
            </Scripts>
            <Services>
        ...
        <div id="divDayEndDetails">
            <table id="grdDayEndDetails">
            </table>
            <div id="grdDayEndDetailsPager">
            </div>
        </div>
