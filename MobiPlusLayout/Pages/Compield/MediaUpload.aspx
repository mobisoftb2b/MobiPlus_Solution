        ...
        <div class="divAllObjs">
            <div style="" class="dAlll">
                <table cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td class="tHead td1">אוכלוסייה
                        </td>
                        <td class="tHead td2">מדייה
                        </td>
                    </tr>
                    <tr>
                        <td class="tBody td1">שופרסל
                        </td>
                        <td class="tBody td2">
                    ...
                    <tr>
                        <td class="tBody td1">אבי כהן בע''מ
                        </td>
                        <td class="tBody td2">
                            <table cellpadding="2" cellspacing="2">
                                <tbody>
                    ...
                    <tr>
                        <td class="tBody td1">גיל גולן בע''מ
                        </td>
                        <td class="tBody td2">
                            <table cellpadding="2" cellspacing="2">
                                <tbody>
            ...
            <div class="ButtonsCls">
                <table width="100%" class="tblBtns">
                    <tr>
                        <td>
                            <input type="button" value="חדש" class="MSBtnGeneral" style="background-image: url('../../Img/plus.png'); width: 80px;"
                                onclick="ShowBox();" />
                        </td>
                        <td>
                            <input type="button" value="ערוך" class="MSBtnGeneral" style="background-image: url('../../Img/edit.png'); width: 80px;"
                                onclick="EditBox();" />
                        </td>
                        <td>
                            <input type="button" value="מחק" class="MSBtnGeneral" style="background-image: url('../../Img/delete.png'); width: 80px;"
                                onclick="DelObj();" />
                        </td>
                    </tr>
                </table>
        ...
        <div id="ObjEditBox" class="ObjEditBox">
            ...
            <table cellpadding="4" cellspacing="2" width="450px">
                <tr>
                    ...
                    <td onclick="ShowCtlPopulations();" class="pop1" id="aPop" style="display: none;">טוען...
            ...
            <div>
                <br />
                <input type="button" id="btnSave" value="שמור" class="MSBtnGeneral" style="background-image: url('../../Img/save.png'); width: 80px; margin-right: 210px"
                    onclick="Save('new')" />
            </div>
        </div>
        <div>
