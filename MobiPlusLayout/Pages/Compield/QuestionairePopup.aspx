<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QuestionairePopup.aspx.cs" Inherits="Pages_Compield_QuestionairePopup" %>
    ...
    <form id="form1" runat="server">
        <asp:ScriptManager ID="ScriptManager1" runat="server">
            <Scripts>
                ...
                <asp:ScriptReference Path="~/js/questionaireUp.js" />
