...
<head id="Head1" runat="server">
    ...
    <link href="../../css/General.css?Ver=<%=ClientVersion %>" rel="stylesheet" type="text/css" />
...
<body onload="setTimeout('parent.CloseLoading();',10);">
    ...
    <div id="ObjEditBox" class="ObjEditBox">
        <div class="JumpWiX" style="padding-right: 3px; padding-top: 2px;">
            <img alt="<%=StrSrc("Close")%>" src="../../img/X.png" class="imngX" onclick="CloseObjEditBox();" />
        </div>
    ...
    <div id="dLoading" class="loading1" style="display:none;">
        <br />
        <img alt="...<%=StrSrc("Loading")%>" src="../../img/loading1.gif" width="50px;" />
        <br />
        <%=StrSrc("KeepGoals")%> ...
    </div>
    <script type="text/javascript">
