...
<body id="dBodyr" onload="try{setTimeout('try{parent.CloseLoading();}catch(e){}',10);}catch(e){}" style="background-color: white; overflow-x: hidden;" onclick="try{parent.CheckSession();}catch(e){}">
    <form id="form1" runat="server">
        ...
        <div id="tt" style="position: absolute; z-index: 99999; direction: ltr; text-align: left; display: none;">gggg</div>
        <div>
    ...
    <script type="text/javascript">
        ...
        function SetStyleValues(StyleName, i, colID, ColName) {
            ...
            {
                //if (t == 5)
                //  console.log("t=" + t, "obj=" + JSON.stringify(obj));
                            ...
                            else
                            {
                                ...
                                for (r = 0; r < obj.length; r++) {
                                    ...
                                    if(obj && obj[r] && obj[r].StyleID && StyleID && StyleID!='' && obj[r].StyleID.toString().toLowerCase().trim() == StyleID.toString().toLowerCase().trim())
                                    {
										...
										$('#tt').text("11");
										var addHtml = "<div style='color:"+color+";font-weight:"+obj[r].isBold+" == 0 ? 500 !important : 700;animation: "+obj[r].isBlink+" == 0 ? none : blinker 1s linear infinite;text-decoration: "+obj[r].isUnderline+" == 0 ? none : underline;background-color: "+bgcolor+";font-size: "+obj[r].FontSize+"px'>"+arrVals[y]+"</div>";
                                        htm+=addHtml;
