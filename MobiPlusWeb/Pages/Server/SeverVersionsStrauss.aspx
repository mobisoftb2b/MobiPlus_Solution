<%@ Page Title="MobiPlus - ניהול גרסאות" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master"
    AutoEventWireup="true" CodeFile="SeverVersionsStrauss.aspx.cs" Inherits="Pages_Server_SeverVersions" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="dBody" style="padding-top: 10px; text-align: right; direction: rtl;">
        <center>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function Refresh()
         ...
         function SaveData()
         {
            ...
            ((!IsAgents && $('#<%= txtProfileID.ClientID%>').val()!="" && $('#<%= txtProfileID.ClientID%>').val()!="" && $('#<%= txtProfileID.ClientID%>').val()!=null) && ($('#<%= ddlFromVersion.ClientID%>').val()!="NULL" && $('#<%= ddlFromVersion.ClientID%>').val()!=null)) || 
        ...
        function ShowGrid() {
            jQuery("#jQGrid").jqGrid({
                ...
                datatype: "json",
                direction: "rtl",
                colNames: ['#',"אוכלוסייה",'# <%=StrSrc("EditWinAgent") %>', '<%=StrSrc("EditWinGroup") %>', '<%=StrSrc("EditWinFromVersion") %>', '<%=StrSrc("EditWinToVersion") %>','',''],
                colModel: [
