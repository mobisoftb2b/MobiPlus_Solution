...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="dEditProfilesItem" class="EditWinProfilesItemBox">
        ...
        <table cellpadding="2" cellspacing="2">
            ...
            <tr id="rCustomer" style="display: none;">
                <td class="EditForm item">פרופיל לקוח:
                </td>
                <td class="EditForm val">
            ...
            <tr id="trOrder">
                <td class="EditForm item">תפריט הזמנה:
                </td>
                <td class="EditForm val">
            ...
            <tr id="trRecipt">
                <td class="EditForm item">תפריט קבלה:
                </td>
                <td class="EditForm val">
        ...
        <div id="div3" style="text-align: center; float: none; padding-top: 10px;">
            <input type="button" value="שמור" class="MSBtnGeneral" style="background-image: url('../../Img/ok.png'); width: 80px;"
    ...
    <div id="EditWinUsersItemBox" class="EditWinUsersItemBox">
        ...
        <table cellpadding="2" cellspacing="2">
            ...
            <tr>
                <td class="EditForm item">אימות סיסמה:
                </td>
                <td class="EditForm val">
            ...
            <tr>
                <td class="EditForm item">פרופיל Mobile:
                </td>
                <td class="EditForm val">
                    <asp:UpdatePanel ID="UpdatePanel5" runat="server" UpdateMode="Always">
                        <ContentTemplate>
                            <asp:DropDownList runat="server" ID="ddlProfilestoUserMobile" Width="150px">
                            </asp:DropDownList>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </td>
            ...
            <tr>
                <td class="EditForm item">עדיפות:
                </td>
                <td class="EditForm val">
                    <asp:UpdatePanel ID="UpdatePanel4" runat="server" UpdateMode="Always">
                        <ContentTemplate>
                            <asp:DropDownList runat="server" ID="ddlDefulttoUser" Width="150px">
                                <asp:ListItem Selected="True" Value="1">עיקרי</asp:ListItem>
                                <asp:ListItem Value="0">משני</asp:ListItem>
                            </asp:DropDownList>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </td>
    ...
    <script type="text/javascript">
        ...
        function ShowEditFormMDUsers() {
            ...
            if (ridmdUsers != "") {
                ...
                $('#<%=ddlProfilestoUserMobile.ClientID %>').val(Row["MobileProfileID"]);
                $('#<%=ddlDefulttoUser.ClientID %>').val(Row["Defult"]);
        ...
        function ShowAddFormMDUsers() {
            $('#<%=hdnMPUserID.ClientID %>').val("0");
            $('#<%=ddlProfilestoUser.ClientID %>').val("-1");
            $('#<%=ddlProfilestoUserMobile.ClientID %>').val("-1");
            $('#<%=ddlDefulttoUser.ClientID %>').val("1");
        ...
        function SetGrid() {
            $("#jQGrid").jqGrid({
                ...
                datatype: "json",
                direction: "rtl",
                colNames: ['#', 'סוג', 'פרופיל', 'שפה', 'ת. ראשי', 'טופס', 'ת. הזמנה', 'ת. קבלה', 'ProfileTypeID', 'AgentProfileID', 'CustomerProfileID', 'OrderMenuID', 'ReceiptMenuID', 'MenuID', 'FormID', 'ProfileID', 'LayoutTypeID'],//'פרופיל לקוח',
                colModel: [{ name: 'ProfileComponentsID', index: 'ProfileComponentsID', width: 30, sorttype: 'int', align: 'right', editable: true },
                            ...
                            { name: 'Language', index: 'Language', width: 30, sorttype: 'text', align: 'right', editable: true },
//                            { name: 'CustomerProfileName', index: 'CustomerProfileName', width: 120, sorttype: 'text', align: 'right', editable: true },
                ...
                ondblClickRow: function (id) {
                    ...
                    function SetGridUsers() {
                        $("#jQGridUsers").jqGrid({
                            ...
                            datatype: "json",
                            direction: "rtl",
                            colNames: ['#', 'משתמש', 'שם', 'תאור', 'סיסמה', 'פרופיל', 'פרופיל Mobile', '', 'ברירת מחדל', 'UserID', 'AgentProfileID', 'UserID2', 'ProfileID', 'MobileProfileID'],
                            colModel: [{ name: 'ProfileComponentsID', index: 'ProfileComponentsID', width: 50, sorttype: 'int', align: 'right', editable: true, hidden: true },
                                        ...
                                        { name: 'Name', index: 'Name', width: 80, sorttype: 'text', align: 'right', editable: true },
                                        ...
                                        { name: 'ProfileName', index: 'ProfileName', width: 80, sorttype: 'text', align: 'right', editable: true },
                                        { name: 'MobileProfileName', index: 'MobileProfileName', width: 180, sorttype: 'text', align: 'right', editable: true },
                                        { name: 'Defult', index: 'Defult', width: 0, sorttype: 'int', align: 'right', editable: true, hidden: true },
                                        { name: 'strDefult', index: 'strDefult', width: 80, sorttype: 'text', align: 'right', editable: true },
                                        ...
                                        { name: 'ProfileID', index: 'ProfileID', width: 0, sorttype: 'int', align: 'right', editable: true, hidden: true },
                                        { name: 'MobileProfileID', index: 'MobileProfileID', width: 0, sorttype: 'int', align: 'right', editable: true, hidden: true }
           ...
           function SetUserData(isToDelete) {
               var LayoutTypeID = "<%=LayoutTypeID %>";
                ...
                + "&Password=" + $('#<%=txtPass.ClientID %>').val() + "&Profileid=" + $('#<%=ddlProfilestoUser.ClientID %>').val() + "&MobileProfileid=" + $('#<%=ddlProfilestoUserMobile.ClientID %>').val() + "&Defult=" + $('#<%=ddlDefulttoUser.ClientID %>').val() + "&UserProfileID=" + $('#<%=hdnUserProfileID.ClientID %>').val() + "&MPUserID=" + $('#<%=hdnMPUserID.ClientID %>').val()
