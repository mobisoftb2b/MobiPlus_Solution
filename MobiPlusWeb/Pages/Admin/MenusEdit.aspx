                ...
                <td class="EditForm val">
                    <asp:UpdatePanel runat="server" ID="upddlHeaderZoomObjs" UpdateMode="Conditional">
                        <ContentTemplate>
                            ...
                            <asp:TextBox runat="server" ID="txtddlItemObjectIDQuestionnaire" Width="220px" Visible="false"></asp:TextBox>
                            <asp:TextBox runat="server" ID="txtddlItemObjectIDPDFForm" Width="220px" Visible="false" style="direction:ltr;text-align:left;"></asp:TextBox>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </td>
            </tr>
    ...
    <script type="text/javascript">
        ...
        function ShowDeleteMenuWin() {
            ...
            if (confirm("האם הנך בטוח ברצונך למחוק את התפריט הבחור?")) {
                request = $.ajax({
                    url: "../../Handlers/MainHandler.ashx?MethodName=Layout_SetMenusForWeb&MenuID=" + $('#<%=ddlMenus.ClientID %>').val() + "&MenuName=" + escape($("#<%=txtMenuName.ClientID %>").val()) + "&MenuDescription=" + escape($("#<%=txtMenuDescription.ClientID %>").val()) + "&isActive=0"+ "&LayoutTypeID="+LayoutTypeID+ "&ViewType="+$("#<%=ddlViewTypeDescription.ClientID %>").val()
        ...
        function SaveCurrentMenu() {
            ...
            // debugger;
            request = $.ajax({
                url: "../../Handlers/MainHandler.ashx?MethodName=Layout_SetMenusForWeb&MenuID=" + MenuID + "&MenuName=" + escape($("#<%=txtMenuName.ClientID %>").val()) + "&MenuDescription=" + escape($("#<%=txtMenuDescription.ClientID %>").val()) + "&isActive=1" + "&LayoutTypeID=" + LayoutTypeID + "&ViewType=" + $("#<%=ddlViewTypeDescription.ClientID %>").val()
                + "&Tiks=<%= DateTime.Now.Ticks.ToString()%>",
                type: "get",
                data: ''
            });
        ...
        function GetMenuData() {
            ...
            request.done(function (response, textStatus, jqXHR) {
                ...
                $("#<%=txtMenuDescription.ClientID %>").val(response[0].MenuDescription);
                $("#<%=txtddlItemObjectIDQuestionnaire.ClientID %>").val("");
                $("#<%=txtddlItemObjectIDPDFForm.ClientID %>").val("");
        ...
        function SaveCurrentMenuItem(isActive) {
            ...
            if($('#<%=ddlItemObjectType.ClientID %>').val()=="4")
                ZoomObj = $('#<%=txtddlItemObjectIDQuestionnaire.ClientID %>').val();
        ...
        function SetObj() {
            ...
            $('#<%= txtddlItemObjectIDQuestionnaire.ClientID %>').val(CurrentObjID);
            $('#<%= txtddlItemObjectIDPDFForm.ClientID %>').val(CurrentObjID);
        }
