        ...
        <div class="dBtnsPr">
            <table width="815px">
                <tr>
                    ...
                    <td>
                        <input type="button" value="שמור" class="MSBtnGeneral btnSave" id="brnSaveSec" style="background-image: url('../../Img/ok.png');
    ...
    <script type="text/javascript">
        ...
        function SaveSections() {
            ...
            request = $.ajax({
                ...
                //dataType: "json",
                data: 'strHTM=' +escape(escape($(".accordionLeft").html())) + '&strJson=' + escape(json)
            });
            request.done(function (response, textStatus, jqXHR) {
        ...
        function ReloadSections() {
            ...
            setTimeout('$(\"#brnSaveSec\").show();',2000);
        }
        function GetReportHTM() {
            ...
            request.done(function (response, textStatus, jqXHR) {
                let content = unescape(response);
                $(".accordionLeft").html(content);
            ...
            request.fail(function (jqXHR, textStatus, errorThrown) {
                ...
                if (jqXHR.status == 200) {
                    let content = unescape(jqXHR.responseText);
                    $(".accordionLeft").html(content);
                    setTimeout('expandAll()', 40);
                    setTimeout('setOnStartUfterexpandAll()', 25);
                    setTimeout('SetResizable()', 45);
