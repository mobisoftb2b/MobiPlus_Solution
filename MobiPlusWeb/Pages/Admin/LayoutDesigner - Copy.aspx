<%@ Page Title="עיצוב מסכים" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master"
    AutoEventWireup="true" CodeFile="LayoutDesigner - Copy.aspx.cs" Inherits="Pages_Admin_LayoutDesigner" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                ...
                <td>
                    ...
                    <div id="divForm" class="divForm" style="visibility: hidden;">
                        ...
                        <div id="divFormBtn" style="visibility: hidden; text-align: left; float: none; width: 925px;">
                            ...
                            <input type="button" id="btnDuplicateFormort" value="שכפל טופס" class="EditForm btn" onclick="ShowDuplicateFormort();" style="display:none;"/>
    ...
    <script type="text/javascript">
        ...
        function DuplicateForm() {
            //DuplicateFormort(context, context.Request["ReportID"].ToString(), context.Request["DuplicateToReportName"].ToString());
            var request;
            request = $.ajax({
