...
public partial class Pages_Admin_MenusEdit : PageBaseCls
{
    ...
    protected void ddlItemObjectType_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            ddlItemObjectID.Visible = true;
            txtddlItemObjectIDQuestionnaire.Visible = false;
            txtddlItemObjectIDPDFForm.Visible = false;
            ...
            switch (ddlItemObjectType.SelectedValue)
            {
                ...
                case "4"://Questionnaire  
                    ...
                    ddlItemObjectID.DataBind();
                    ddlItemObjectID.Visible = false;
                    txtddlItemObjectIDQuestionnaire.Visible = true;
                    break;
                ...
                case "7"://Printer
                    ...
                    break;
                case "9"://PDF Form  
                    ddlItemObjectID.DataSource = wr.Layout_GetPDFForms(ConStrings.DicAllConStrings[SessionProjectName], LayoutTypeID);
                    ddlItemObjectID.DataTextField = "PDFFormName";
                    ddlItemObjectID.DataValueField = "PDFFormID";
                    ddlItemObjectID.DataBind();
                    break;
            }
        }
