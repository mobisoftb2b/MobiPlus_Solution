<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ClientWS.aspx.cs" Inherits="tests_ClientWS" %>
...
<body style="background-color: #3F3D47; color: White; font-size: 20px;">
    ...
    <script type="text/javascript">
        var socket;
        function Con() {
            socket = new WebSocket('ws://10.0.0.85:7051/PushServer?AgentID=1234;9-8-7-6&NewWS=true');
            //socket = new WebSocket('ws://10.0.0.85:8095/PushServer?AgentID=gg;9-8-7-6&NewWS=true');
