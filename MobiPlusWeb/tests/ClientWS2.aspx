<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ClientWS2.aspx.cs" Inherits="tests_ClientWS" %>
...
<body style="background-color: #3F3D47; color: White; font-size: 20px;">
    ...
    <script type="text/javascript">
        var socket;
        function Con() {
            //socket = new WebSocket('ws://10.0.0.85:8097/PushServer?AgentID=1234;3-4-5-6&NewWS=true'); //3456;8-7-6-5
            socket = new WebSocket('ws://10.24.21.183:9093/PushServer?AgentID=uu;3-4-5-6&NewWS=true'); //3456;8-7-6-5
