...
public class MobiPlusWS : ServiceBaseCls
{
    ...
    public bool Layout_SetForm(string FormID, string LayoutTypeID, string FormName, string FormDescription, string IsShowUpdateTime, string IsTabAlwaysOnTop, string IsActive, string TabAlignmentID, string UserID,
        string ProjectID, string ConString)
    {
        return DAL.DAL.Layout_SetForm(FormID, LayoutTypeID, FormName, FormDescription, IsShowUpdateTime, IsTabAlwaysOnTop, IsActive, TabAlignmentID, UserID, ProjectID, ConString);
    }
    [WebMethod]
    [ScriptMethod(UseHttpGet = true)]
    ...
    [WebMethod]
    [ScriptMethod(UseHttpGet = true)]
    public bool Layout_SetFormTab(string FormID, string TabID, string TabName, string TabDescription, string IsActive, string UserID, string ConString, string LayoutTypeID, string FiltersJson)
    {
        return DAL.DAL.Layout_SetFormTab(FormID, TabID, TabName, TabDescription, IsActive, UserID, ConString, LayoutTypeID, FiltersJson);
    }
    [WebMethod]
    [ScriptMethod(UseHttpGet = true)]
            ...
            string ActionBattonOnTitleReportZoomObjTypeID, string ActionBattonOnTitleReportZoomObjID, string SectionsPerRow, string SectionsRowHeight, string IsToShowSectionFrame, string SectionImageHeightWeight, string IsWebInternal)
    {
        return DAL.DAL.Layout_SetFormReport(ReportID, ReportName, ReportQuery, Report_SP_Params, ReportCaption, ReportDataSourceID,
           ...
           , ShowActionBattonOnTitle, ActionBattonOnTitleText, ActionBattonOnTitleReportZoomObjTypeID, ActionBattonOnTitleReportZoomObjID, SectionsPerRow, SectionsRowHeight, IsToShowSectionFrame, SectionImageHeightWeight, IsWebInternal);
    }
    [WebMethod]
    [ScriptMethod(UseHttpGet = true)]
    ...
    public bool Layout_SetReportCol(string ColID, string ReportID, string ColName, string ColCaption, string ColOrder, string ColWidthWeight, string ColTypeID
            , string FormatID, string AlignmentID, string ColMaxLength, string StyleID, string ColIsSummary, string IsActive, string UserID, string ConString)
    {
        return DAL.DAL.Layout_SetReportCol(ColID, ReportID, ColName, ColCaption, ColOrder, ColWidthWeight, ColTypeID
            , FormatID, AlignmentID, ColMaxLength, StyleID, ColIsSummary, IsActive, UserID, ConString);
    }
    ...
    {
        return DAL.DAL.Layout_SetFragmentsToTabsByJson(FormID, JsonObj, UserID, ConString);
    }
    ...
    {
        ResponseJSON(GetJson(DAL.DAL.Layout_GetUsersProfileComponents(LayoutTypeID, ConString)));
    }
    [WebMethod(EnableSession = true)]
    [ScriptMethod(ResponseFormat = ResponseFormat.Json, UseHttpGet = true)]
    public string Layout_SetUserData(string Name, string Description, string UserName, string Password, string Profileid, string IsToDelete, string MPUserID, string UserID,
           string LayoutTypeID, string UserProfileID, string ConString)
    {
        return DAL.DAL.Layout_SetUserData(Name, Description, UserName, Password, Profileid, IsToDelete, MPUserID, UserID,
           LayoutTypeID, UserProfileID, ConString);
    }
    [WebMethod(EnableSession = true)]
    [ScriptMethod(UseHttpGet = true)]
