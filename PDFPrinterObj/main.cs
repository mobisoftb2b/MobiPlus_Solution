...
namespace PDFPrinterObj
{
    public class main
    {
        public main()
        {
            if (System.Configuration.ConfigurationSettings.AppSettings["PSDSrc"].ToString() != "")
                Worker.PSDSrc = System.Configuration.ConfigurationSettings.AppSettings["PSDSrc"].ToString();

            if (System.Configuration.ConfigurationSettings.AppSettings["LogDirectory"].ToString() != "")
                Worker.LogDir = System.Configuration.ConfigurationSettings.AppSettings["LogDirectory"].ToString();


            if (System.Configuration.ConfigurationSettings.AppSettings["LoopSleap"].ToString() != "")
                Worker.LoopSleap = Convert.ToInt32(System.Configuration.ConfigurationSettings.AppSettings["LoopSleap"].ToString());

            if (System.Configuration.ConfigurationSettings.AppSettings["PrinterEXE"].ToString() != "")
                Worker.PrinterEXE = System.Configuration.ConfigurationSettings.AppSettings["PrinterEXE"].ToString();

            Tools.AddRowToLog("*******************Service Start******************", Worker.LogDir, "PrinterLog");
            new Thread(() =>
            {
                Worker.StartWorker();
            }).Start();
        ...
        ~main()
        {
            Tools.AddRowToLog("*******************Service Stopped******************", Worker.LogDir, "PrinterLog");
    ...
    public static class ProcessAsCurrentUser
    {
        ...
        private static IntPtr GetCurrentUserToken()
        {
            ...
            //Tools.AddRowToLog("sessionId: " + sessionId, Worker.LogDir, "PrinterLog");
