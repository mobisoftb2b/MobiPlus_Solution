<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PersonGauges.aspx.cs" Inherits="PQ.Admin.Presentation.Gauge.PersonGauges" %>
    ...
    <div>
        <div id="content">
            <div class="div_wrapper">
                ...
                <div id="gaugeDiv" style="width: 220px; height: 210px; text-align: center">
                </div>
            </div>
        </div>
        <div id="divBg">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function (e) {
                ...
                if (qParam.gg) {
                    ...
                    if (typeof bindows === 'object')
                        speedGauge = window.bindows.loadGaugeIntoDiv('<%= this.ResolveClientUrl("~/Resources/XSLT/personLevelGauge.xml") %>', "gaugeDiv");
                    else
                        speedGauge = window.parent.speedGauge; //.loadGaugeIntoDiv('<%= this.ResolveClientUrl("~/Resources/XSLT/personLevelGauge.xml") %>', "gaugeDiv");
            ...
            function SetGauge() {
                ...
                function update() {
                    ...
                    //                    speedGauge.label.setText(" " + Math.round(speed));
                }
