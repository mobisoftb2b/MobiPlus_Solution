...
{
    var pathtojsfiles = "/opeReady/Resources/Scripts/Common/"; // need to be ajusted
    // set include to false if you do not want some modules to be included
    var modules = [
        { include: true, incfile: 'i18n/grid.locale-en.js' }, // jqGrid translation
        {include: true, incfile: 'jqGrid/grid.base.js' }, // jqGrid base
        {include: true, incfile: 'jqGrid/grid.common.js' }, // jqGrid common for editing
