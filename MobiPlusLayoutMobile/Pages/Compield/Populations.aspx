...
<body id="dBodyr" onload="setTimeout('parent.CloseLoading();',10);">
    ...
    <div id="dEditWinPopItemBox" class="dEditWinPopItemBox">
        <div class="JumpWiX">
            <img alt="סגור" src="../../img/X.png" class="imngX" onclick="CloseEditWinPopItemBox();" />
        </div>
        ...
        <div id="div3" style="text-align: center; float: none; padding-top: 10px;">
            <input type="button" value="שמור" class="MSBtnGeneral" style="background-image: url('../../Img/ok.png');
                width: 80px;" onclick="SetPopData('0','2');" />
    ...
    <script type="text/javascript">
        ...
        function ShowEditFormMDCategories() {
            ...
            if(ridmd=="0" || ridmd =="") {
                alert("אנא בחר אוכלוסייה מן הגריד תחילה.");
                return;
            }
            if (ridmd != "") {
       ...
       function ShowCtlPopulationsCategories() {
        ...
        function ShowDeleteFormMDCategories() {
            ...
            if (confirm("האם אתה בטוח ברצונך למחוק את האוכלוסייה המסומנת מן הגריד?")) {
                SetPopData('1','3');
            }
        }
