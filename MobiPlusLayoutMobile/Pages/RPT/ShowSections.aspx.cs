...
public partial class Pages_RPT_ShowSections : PageBaseCls
{
    ...
    private void init()
    {
        ...
        DataTable dtRep = WR.MPLayout_GetReportData(ReportID, SessionVersionID, ConStrings.DicAllConStrings[SessionProjectName]);
        int Counter = 0;
