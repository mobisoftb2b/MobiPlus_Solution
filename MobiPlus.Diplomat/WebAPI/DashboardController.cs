...
namespace MobiPlus.Diplomat.WebAPI
{
    ...
    public class DashboardController : ApiController
    {
        ...
        {
            return await new DashboardService().Layout_POD_WEB_NotesCollectionAsync(param);
        }
        #endregion
        ...
        {
            return await new DashboardService().Layout_POD_WEB_AgentsReportAsync(param);
        }
        [HttpPost]
        public async Task<IEnumerable<DriverReportsNT>> Layout_POD_WEB_AgentsReportNoTargetAsync(FilterParams param)
        {
            return await new DashboardService().Layout_POD_WEB_AgentsReportNoTargetAsync(param);
        }
        #endregion
        ...
        #region Customers
        [HttpPost]
        public async Task<IEnumerable<CustomerModel>> Layout_POD_WEB_AgentDailyActivityAsync([FromBody]FilterParams inParams)
        {
            return await new DashboardService().Layout_POD_WEB_AgentDailyActivityAsync(inParams);
        }

        [HttpPost]
        public async Task<IEnumerable<CustomerModel>> Layout_POD_WEB_AgentDailyActivity_PopUpAsync([FromBody]FilterParams inParams)
        {
            return await new DashboardService().Layout_POD_WEB_AgentDailyActivity_PopUpAsync(inParams);
        }
