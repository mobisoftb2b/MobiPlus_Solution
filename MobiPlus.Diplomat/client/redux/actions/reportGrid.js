...
//==========================Customers Report Grid Data========================================================== 

export function fetchCustomersGridData(params) {
    return (dispatch) => fetch('/api/Dashboard/Layout_POD_WEB_AgentDailyActivityAsync',{ 
        method: "POST",
        body: JSON.stringify(params),
        headers: {
            "Content-Type": "application/json"
        ...
        .then(responce => responce.json())
        .then(data => dispatch(setCustomersGridData(data)));
}


export function setCustomersGridData(customersData) {
    return {
        type: ActionTypes.CUSTOMERS_DATA,
        customersData
    };
}

export function fetchCustomersDetailsGridData(params) {
    return (dispatch) => fetch('/api/Dashboard/Layout_POD_WEB_AgentDailyActivity_PopUpAsync',{ 
        method: "POST",
        body: JSON.stringify(params),
        headers: {
            "Content-Type": "application/json"
        ...
        .then(responce => responce.json())
        .then(data => dispatch(setCustomersDetailsGridData(data)));
}


export function setCustomersDetailsGridData(custDetailsData) {
    return {
        type: ActionTypes.CUSTOMERSDETAILS_DATA,
        custDetailsData
    };
}
