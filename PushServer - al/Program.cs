    ...
    {        
        ...
        public static void Start()
        {
            try
            {
                ...
                _server = new WebSocketServer(8097, IPAddress.Loopback) { OnReceive = OnServerReceive };
                _server.Start();

                
                //var wssv = new WebSocketServer("wss://10.0.0.31");
       ...
       */
               ...
               // wssv.Start();
                ...
                //if (wssv.IsListening)
                {
                    Tools.AddRowToLog("WebSocket push server listening on port: 8097;", LogDirectory, LogFileName);
